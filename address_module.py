...
def load_address_dict(project_path, dir_name):
    ...
    add_dicts.huyen_thitran = json.load(open(os.path.join(dir_path, 'px', 'huyen_thitran.json'), 'r', encoding='utf-8'))
    add_dicts.huyen_xa = json.load(open(os.path.join(dir_path, 'px', 'huyen_xa.json'), 'r', encoding='utf-8'))
    add_dicts.quan_phuong = json.load(open(os.path.join(dir_path, 'px', 'quan_phuong.json'), 'r', encoding='utf-8'))
    ...
    add_dicts.tp_phuong = json.load(open(os.path.join(dir_path, 'px', 'tp_phuong.json'), 'r', encoding='utf-8'))
    #add_dicts.tp_thitran = json.load(open(os.path.join(dir_path, 'px', 'tp_thitran.json')))
    add_dicts.tp_xa = json.load(open(os.path.join(dir_path, 'px', 'tp_xa.json'), 'r', encoding='utf-8'))
    add_dicts.tx_phuong = json.load(open(os.path.join(dir_path, 'px', 'tx_phuong.json'), 'r', encoding='utf-8'))
    #add_dicts.tx_thitran = json.load(open(os.path.join(dir_path, 'px', 'tx_thitran.json')))
    add_dicts.tx_xa = json.load(open(os.path.join(dir_path, 'px', 'tx_xa.json'), 'r', encoding='utf-8'))

    # tinh_huyen
    add_dicts.thanhpho_huyen = json.load(open(os.path.join(dir_path, 'qh', 'thanhpho_huyen.json'), 'r', encoding='utf-8'))
    #add_dicts.thanhpho_tp = json.load(open(os.path.join(dir_path, 'qh', 'thanhpho_tp.json')))
    add_dicts.thanhpho_quan = json.load(open(os.path.join(dir_path, 'qh', 'thanhpho_quan.json'), 'r', encoding='utf-8'))
    add_dicts.tinh_huyen = json.load(open(os.path.join(dir_path, 'qh', 'tinh_huyen.json'), 'r', encoding='utf-8'))
    #add_dicts.tinh_quan = json.load(open(os.path.join(dir_path, 'qh', 'tinh_quan.json')))
    add_dicts.tinh_tp = json.load(open(os.path.join(dir_path, 'qh', 'tinh_tp.json'), 'r', encoding='utf-8'))
    add_dicts.tinh_tx = json.load(open(os.path.join(dir_path, 'qh', 'tinh_tx.json'), 'r', encoding='utf-8'))

    # HCMHN
    add_dicts.hcm_hn_huyen = json.load(open(os.path.join(dir_path, 'hcmhn', 'hcmhn_huyen.json'), 'r', encoding='utf-8'))
    add_dicts.hcm_hn_quan = json.load(open(os.path.join(dir_path, 'hcmhn', 'hcmhn_quan.json'), 'r', encoding='utf-8'))
    add_dicts.hcm_hn_tx = json.load(open(os.path.join(dir_path, 'hcmhn', 'hcmhn_tx.json'), 'r', encoding='utf-8'))
    add_dicts.hcm_hn_tp = json.load(open(os.path.join(dir_path, 'hcmhn', 'hcmhn_tp.json'), 'r', encoding='utf-8'))
